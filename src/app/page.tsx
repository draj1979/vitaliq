...
const TRUSTED = [
  { name: "Tata 1mg", sub: "Labs" },
  { name: "Apollo 24|7", sub: "Pharmacy" },
  { name: "Dr Lal PathLabs", sub: "Delhi" },
  { name: "Metropolis", sub: "Diagnostics" },
  { name: "PharmEasy", sub: "Mumbai" },
  { name: "Practo", sub: "Bengaluru" },
];
    ...
    <div className="min-h-screen w-full bg-bone text-fg2">
      ...
      <section className="border-y bg-bone-50" style={{ borderColor: "var(--border)" }}>
        <div className="mx-auto max-w-[1240px] px-6 py-10 md:px-10">
          <div className="text-center text-[12px] tracking-[-0.005em] text-fg3">
            Loved by <span className="text-fg1 font-medium">2 lakh families</span>, synced with India&apos;s leading labs and pharmacies
          </div>
      ...
      >
        <div className="mx-auto max-w-[1240px] px-6 py-24 text-center md:px-10 md:py-32">
          ...
          >
            Free to start. No card required. Import your first reports in minutes.
          </p>
      ...
      >
        <div className="mx-auto grid max-w-[1240px] gap-10 px-6 py-14 md:grid-cols-[1.6fr_1fr_1fr_1fr_1fr] md:px-10">
          ...
          {[
            { h: "Product", items: ["Records", "Insights", "Guidance", "Integrations", "Changelog"] },
            { h: "Solutions", items: ["For individuals", "For families", "For caregivers", "Chronic care", "Seniors"] },
